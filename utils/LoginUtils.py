...
class LoginSite:
    USERNAME = "admin"
    PASSWORD = "Hokgadau170102#"
    URLLOGINPAGE = "http://localhost/moodle/"
    LOGOUT_BUTTON_XPATH = "//a[starts-with(@href, 'http://localhost/moodle/login/logout.php')]"
    LOGIN_BUTTON_XPATH = "//a[starts-with(@href, 'http://localhost/moodle/login/index.php')]"
